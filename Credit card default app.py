...
def main():
    st.title("Credit Card Defaulter Web App")
    st.sidebar.title("Credit Card Defaulter Web App")
    st.markdown("Chances of account going to default in the next month 💳")
    ...
    st.sidebar.markdown("Chances of account going to default in the next month 💳")

    @st.cache(persist=True)
    def load_data():
        data = pd.read_csv("C:/Users/omu/Desktop/TECHNOCOLABS/cleaned_data.csv")
